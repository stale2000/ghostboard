...
export function MediaStage({ mediaSource, mediaLabel, statusLabel, children }: MediaStageProps) {
  return (
    <section
      style={{
    ...
    >
      ...
      >
        {mediaSource ? (
          ...
          <div style={{ color: "#94a3b8", fontSize: 14, maxWidth: 480, padding: 24, textAlign: "center" }}>
